...
const tables = require('../../runtime/node-broker/companion/protocolTables.json')
const protocol = require('../../runtime/node-broker/companion/protocol.cjs')
const { COMMAND_CAPABILITIES } = protocol
