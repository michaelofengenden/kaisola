...
@interface TerminalView (SWIFT_EXTENSION(SwiftTerm))
/// Controls whether font smoothing (sub-pixel rendering) is enabled during glyph drawing.
/// Set to <code>false</code> to get thinner strokes on Retina displays, matching iTerm2’s “Thin strokes” setting.
/// Defaults to <code>true</code> (standard macOS font smoothing).
@property (nonatomic) BOOL fontSmoothing;
