...
- Glass is whiter. The sidebar, the file panel and the canvas all read grey rather than white, because the white veil over your desktop was thin enough that the desktop dominated it. All three carry more white now and stay translucent: the desktop still shows through at just under half, well inside the range the surfaces are solved for.
