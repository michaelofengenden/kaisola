...
off-main cached Markdown images. Finish the large-document architecture.
...
- Add PDFKit previews and split the preview monolith into recovery, tabs,
  editors, Markdown, assets, and content-preview units with typed notice/error
  channels.
