...
enum TerminalTheme {
    ...
    /// is literal white as well. ANSI black inverts to that same paper, while
    /// every text-bearing ANSI role clears 4.5:1 against it.
    static var light: Palette {
        Palette(
            ...
            ansi: [
                term(0xFFFFFF), term(0xC43D3D), term(0x1A7F37), term(0x7D4E00),
