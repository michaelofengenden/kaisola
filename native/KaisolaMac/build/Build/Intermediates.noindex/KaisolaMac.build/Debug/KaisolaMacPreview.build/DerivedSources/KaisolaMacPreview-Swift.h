...
#ifndef KAISOLAMACPREVIEW_SWIFT_H
#define KAISOLAMACPREVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KaisolaMacPreview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSNumber;
SWIFT_PROTOCOL("_TtP17KaisolaMacPreview26BrokerBootstrapXPCProtocol_")
@protocol BrokerBootstrapXPCProtocol
- (void)launchBrokerWithConfigurationPath:(NSString * _Nonnull)configurationPath withReply:(void (^ _Nonnull)(NSNumber * _Nullable, NSString * _Nullable))reply;
@end

@class NSNotification;
@class NSApplication;
SWIFT_CLASS("_TtC17KaisolaMacPreview21KaisolaMacAppDelegate")
@interface KaisolaMacAppDelegate : NSObject <NSApplicationDelegate, NSWindowDelegate>
...
SWIFT_CLASS("_TtC17KaisolaMacPreview22NativeUpdateController")
@interface NativeUpdateController : NSObject
...
SWIFT_CLASS("_TtC17KaisolaMacPreview20ReadOnlyTerminalView")
@interface ReadOnlyTerminalView : TerminalView
...
/// path stays intact and lands in the delegate’s <code>send</code>, which the surface
/// forwards to the broker controller connection.
SWIFT_CLASS("_TtC17KaisolaMacPreview17OwnedTerminalView")
@interface OwnedTerminalView : ReadOnlyTerminalView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
