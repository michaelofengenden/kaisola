...
\- also can we make it so I can add multiple subscriptions of claude code/codex? such that I can stay signed in to all of them, and whenever I login to one on terminal I can choose
