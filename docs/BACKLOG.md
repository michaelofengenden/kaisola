...
\- the settings bar  can be fixed further as well, the settings can just included inside the profile of the user, and the notifications and search button need to be on the same level.   
